          ...
          <table class="w-full min-w-[540px]" data-tab-for="order" data-page="active">
            ...
            <tr v-for="(pcimage) in images" :key="pcimage.EAN">
              <td class="py-2 px-4 border-b border-b-gray-50">
                <span class="text-[13px] font-medium text-gray-400">{{ pcimage["Article NR"] }}</span>
              </td>
              <td class="py-2 px-4 border-b border-b-gray-50">
                <span class="text-[13px] font-medium text-gray-400">{{ pcimage["EAN"] }}</span>
              </td>
              <td class="py-2 px-4 border-b border-b-gray-50">
                <span class="text-[13px] font-medium text-gray-400">{{ pcimage["Brand"] }}</span>
              </td>
              <td class="py-2 px-4 border-b border-b-gray-50">
