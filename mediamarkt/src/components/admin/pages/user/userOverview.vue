    ...
    <div class="mb-6">
      <div class="mt-40 md:mt-0 bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
        ...
        <div class="flex flex-col sm:flex-row items-center mb-4 order-tab">
          ...
          <button @click="activeUsers" type="button" class="bg-gray-50 text-sm font-medium text-gray-400 py-2 px-4 hover:text-gray-600">admin's</button>
          <button @click="disabledUsers" type="button" class="bg-gray-50 text-sm font-medium text-gray-400 py-2 px-4 rounded-tr-md rounded-br-md hover:text-gray-600">Medewerkers</button>
